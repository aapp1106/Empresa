...
namespace Empresa.Clases
{
    public class CreateExcelFile
    {
        ...
        public static bool CreateExcelDocumentConNombreHoja<T>(List<T> list, string xlsxFilePath, string NombreHoja)
        {
            DataSet ds = new DataSet();
            var TableNew = ListToDataTable(list);
            TableNew.TableName = NombreHoja;
            ds.Tables.Add(TableNew);
